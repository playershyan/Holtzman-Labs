      ...
      <section className="py-16 md:py-24 bg-black">
        <div className="max-w-6xl mx-auto px-6 md:px-16 lg:px-24">
          ...
          <div className="max-w-3xl">
            ...
            <div>
              <div className="mb-10">
                <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight mb-3">
                ...
                <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight mb-8">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-16 lg:px-24">
        <div className="max-w-3xl">
          <div className="mb-8 border-l-4 border-[#7C3AED] pl-6">
            <p className="text-xl md:text-2xl text-gray-200 font-semibold leading-relaxed mb-2">
